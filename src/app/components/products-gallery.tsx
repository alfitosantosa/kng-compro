...
export default function ProductGallery() {
  ...
  const allProducts: Product[] = [
    ...productsData.orthosis_protesis,
    ...productsData.mobility_aids,
    ...productsData.rehabilitation_equipment,
  ]
  ...
  const filteredProducts =
    selectedCategory === "all"
      ...
      : allProducts.filter((product) => {
          ...
          if (selectedCategory === "rehabilitation")
            return productsData.rehabilitation_equipment.includes(product as any)
          return false
        })
    ...
    <div className="container mx-auto px-4">
      <div className="text-center mb-8 md:mb-16">
        ...
        <p className="text-lg md:text-xl text-muted-foreground max-w-2xl mx-auto">
          Jelajahi koleksi lengkap produk berkualitas tinggi untuk mendukung mobilitas dan rehabilitasi
        </p>
      </div>
          ...
          <ProductModal key={product.id} product={product}>
            <Card className="cursor-pointer transition-all hover:shadow-lg hover:-translate-y-1">
              ...
              <CardContent className="pt-0">
                <CardDescription className="text-xs md:text-sm line-clamp-2 mb-3">
                  {product.description}
                </CardDescription>
